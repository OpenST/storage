...
const ManagedShardItemKlass = function(paramDdbItem) {
  ...
  defineProperty(oThis, 'identifier', ddbItem[managedShardConst.IDENTIFIER]['S']);

  defineProperty(oThis, 'entityType', ddbItem[managedShardConst.ENTITY_TYPE]['S']);

  defineProperty(oThis, 'shardName', ddbItem[managedShardConst.SHARD_NAME]['S']);

  defineProperty(oThis, 'createdAt', ddbItem[managedShardConst.CREATED_AT]['N']);

  defineProperty(oThis, 'updatedAt', ddbItem[managedShardConst.UPDATED_AT]['N']);
};
