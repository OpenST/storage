 ...
 * @constructor
 */
const LibAutoScaleBase = function() {
  const oThis = this,
  ...
  call: function(method, ...methodArgs) {
    ...
    return new Promise(function(onResolve) {
      try {
        ...
        logger.error('lib/autoScale/Base.js:call inside catch ', err);
        return onResolve(
          responseHelper.error({
...
InstanceComposer.registerAsShadowableClass(LibAutoScaleBase, coreConstant.icNameSpace, 'LibAutoScaleBase');
