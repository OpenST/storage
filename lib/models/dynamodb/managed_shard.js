...
const Item = function (paramDdbItem) {
  ...
  defineProperty(oThis, "entityType",
    managedShardConst.getSupportedInverseEntityTypes()[ddbItem[managedShardConst.ENTITY_TYPE]['S']]
  );
  ...
  defineProperty(oThis, "createdAt",
    ddbItem[managedShardConst.CREATED_AT]['S']
  );

  defineProperty(oThis, "updatedAt",
    ddbItem[managedShardConst.UPDATED_AT]['S']
  );
};
