...
Base.prototype = {
  ...
  queryDdb: async function(methodName, preferredEndPoint, ...params) {
    const oThis = this,
      dynamoFactory = oThis.ic().getInstanceFor(coreConstants.icNameSpace, 'getDynamoConfigFactory');
...
InstanceComposer.registerAsObject(Base, coreConstants.icNameSpace, 'getLibDynamoDBBase', true);
