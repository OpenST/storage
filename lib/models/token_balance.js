...
const tokenBalanceModelSpecificPrototype = {
  ...
  update: async function(params) {
    ...
    if(updateResponse.isSuccess() && updateResponse.data && updateResponse.data.Attributes){
      ...
      if((responseDbData.settled_balance && responseDbData.settled_balance < 0) ||
        ...
        console.error('negativeBalance ethereum_addresses: ', params['ethereum_address'], " erc20_contract_address ", oThis.erc20ContractAddress);
  ...
  set: async function(params) {
    ...
    console.log("-2222--------Storage:::set--------params-", JSON.stringify(params));
    if(settleAmount){
    ...
    console.log('-------------updateExpression--',updateExpression, JSON.stringify(ExpressionAttributeValues));
    console.log("SET "+ updateExpression.join(','));
    ...
    console.log("-2222----2----Storage:::set--------updateResponse-", JSON.stringify(updateResponse));
