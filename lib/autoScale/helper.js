...
const AutoScaleHelper = function() {};

AutoScaleHelper.prototype = {
...
InstanceComposer.registerAsObject(AutoScaleHelper, coreConstant.icNameSpace, 'autoScaleHelper', true);

module.exports = AutoScaleHelper;
