...
const Item = function (paramDdbItem) {
  ...
  defineProperty(oThis, "entityType",
    managedShardConst.getSupportedInverseEntityTypes()[ddbItem[availableShardConst.ENTITY_TYPE]['S']]
  );
  ...
  defineProperty(oThis, "createdAt",
    ddbItem[availableShardConst.CREATED_AT]['S']
  );

  defineProperty(oThis, "updatedAt",
    ddbItem[availableShardConst.UPDATED_AT]['S']
  );
};
