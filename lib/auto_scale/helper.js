...
const AutoScaleKlass = function() {};

AutoScaleKlass.prototype = {
...
InstanceComposer.registerAsObject(AutoScaleKlass, coreConstants.icNameSpace, 'getAutoScaleHelper', true);

module.exports = AutoScaleKlass;
