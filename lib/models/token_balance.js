...
TokenBalanceModel.prototype = {
  ...
  createAndRegisterShard: async function (shardName) {
    ...
    const createTableParams = {
      ...
      AttributeDefinitions: [
        ...
        { AttributeName: "unsettled_debits", AttributeType: "N" },
        { AttributeName: "settled_balance", AttributeType: "N" },
    ...
    let configureShardResponse = shardMgmtObj.configureShard(configureShardParams);
  ...
  pessimisticDebit: async function(params){
    ...
    const debitParams = {
      ...
      UpdateExpression: "set unsettled_debits = unsettled_debits + :num",
      ExpressionAttributeValues: {
        ":num": {N: params['debitAmount']}
      },
      ReturnValues: "NONE"
    };
  ...
  settle: async function(params){
    ...
    const debitParams = {
      TableName: oThis.shardName,
      Key: oThis._keyObj(params),
      UpdateExpression: "set unsettled_debits = unsettled_debits - :num, settled_balance = settled_balance + :num",
      ExpressionAttributeValues: {
        ":num": {N: params['settleAmount']}
      },
      ReturnValues: "NONE"
    };
  ...
  _keyObj: function (params) {
    return {
      ...
      erc20_contract_address: {
        S: params['erc20_contract_address']
      }
    }
  }
