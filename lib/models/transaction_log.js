...
const transactionLogModelSpecificPrototype = {
  ...
  _formatDataForGetItem: function (rowData) {
    ...
    if (rowData.hasOwnProperty(oThis.shortNameFor('commission_percent'))) {
      formattedRowData['commission_percent'] = rowData[oThis.shortNameFor('commission_percent')]['N'];
    }
    ...
    if (rowData.hasOwnProperty(oThis.shortNameFor('bt_transfer_in_wei'))) {
      formattedRowData['bt_transfer_in_wei'] = rowData[oThis.shortNameFor('bt_transfer_in_wei')]['N'];
    }
    ...
    if (rowData.hasOwnProperty(oThis.shortNameFor('transfer_events'))) {
      ...
      for(let i=0; i<rawTransferEventsData.length; i++) {
        ...
        formattedBuffer['amount'] = parseInt(buffer[oThis.shortNameFor('amount')]['N']);
