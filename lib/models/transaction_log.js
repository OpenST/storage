...
const transactionLogModelSpecificPrototype = {
  ...
  _formatDataForPutItem: function (rowData) {
    ...
    if (rowData.hasOwnProperty('airdrop_amount') && rowData['airdrop_amount'] != null) {
      formattedRowData[oThis.shortNameFor('airdrop_amount')] = {N: rowData['airdrop_amount'].toString()};
    }
  ...
  _formatDataForGetItem: function (rowData) {
    ...
    if (rowData.hasOwnProperty(oThis.shortNameFor('airdrop_amount'))) {
      formattedRowData['airdrop_amount'] = rowData[oThis.shortNameFor('airdrop_amount')]['N'];
    }
