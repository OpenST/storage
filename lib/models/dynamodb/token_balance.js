...
const tokenBalanceModelSpecificPrototype = {
  ...
  update: async function(params) {
    ...
    let TokenBalanceCache = oThis.ic().getShadowedClassFor(coreConstants.icNameSpace, 'getDDBTokenBalanceCache');
...
InstanceComposer.registerAsShadowableClass(TokenBalanceModel, coreConstants.icNameSpace, 'getLibDDBTokenBalanceModel');
